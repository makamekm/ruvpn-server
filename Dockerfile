...
ENV RUPN_ENABLE_VP8_RESTART_WATCHDOG=true
ENV RUPN_VP8_INGRESS_FROZEN_AFTER_SECONDS=60
ENV RUPN_VP8_ZERO_INGRESS_AFTER_SECONDS=30
ENV RUPN_VP8_RESTART_BACKOFF_SECONDS=600
